...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> resourceNorFoundException(@NotNull ResourceNotFoundException resourceNotFoundException, @NotNull HttpServletRequest httpServletRequest) {
    ...
    public ResponseEntity<StandardError> dataBaseException(@NotNull DatabaseException databaseException, @NotNull HttpServletRequest httpServletRequest) {
